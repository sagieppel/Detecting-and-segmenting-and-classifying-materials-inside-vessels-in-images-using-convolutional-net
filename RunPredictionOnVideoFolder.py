...
############################################Input parameters###################################################################################
#-------------------------------------Input parameters-----------------------------------------------------------------------
MainInputVideosFolder=r"/media/sagi/2T/ChemScape/YouTube/Percipitation//"
OutPutVideoFolder=r"/media/sagi/2T/ChemScape/YouTube/OutPercipitation//"
...
for InputVideo in os.listdir(MainInputVideosFolder):
    ...
    #------------------------------------Display main classes on the image----------------------------------------------------------------------------------
        ...
        for nm in MainCatName:
            ...
            ImOverlay1 = Im.copy()
            ImOverlay1[:, :, 1][Lb==1] = 0
            cv2.putText(ImOverlay1, nm.replace("GENERAL",""), ( int(w/3), int(h/6)), font, 2, (0, 255, 0), 2, cv2.LINE_AA)
