...
#-------------------------------------Input output folder-----------------------------------------------------------------------
import os
InputDir=r"/media/sagi/2T/ChemScape/YouTube/MultiPhase/"
OutputDir=r"/media/sagi/2T/ChemScape/YouTube/MultiPhase_OUT/" #Output video that contain vessel filled  liquid and solid
...
for InputVideo in os.listdir(InputDir):
    ...
    # --------------------Convert new annotation map to match old annotation map for frame consistancy basically phase Tracker--------------------------------------------------------------------------------------
       ...
       # print("rrrr")
        ...
        InsVizVesPart = InsVizVesPart * 0.66 + Im * 0.34
    ...
    #---------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if VideoWriter is None:
            h, w, d = VizImg.shape
            VideoWriter = cv2.VideoWriter(OutVideoName, fourcc, 15, (w, h))
